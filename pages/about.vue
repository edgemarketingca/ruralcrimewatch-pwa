...
<template>
  <main class="dark:text-white">
    ...
    <div class="flex flex-col gap-8 my-4 pl-4">
      <p>
    ...
    <div class="p-4 mb-4 text-sm text-primary rounded-lg bg-green-50 dark:bg-neutral-900 font-bold" role="alert">
      v{{ version }}
    </div>
  </main>
</template>